    ...
    async def glass(self, ctx, member: discord.Member = None):
        ...
        try:
            async with aiohttp.ClientSession() as jailSession:
                async with jailSession.get(f'https://api.betterbot.ru/v2/filter/glass?avatar={member.avatar.url}') as jailImg:
